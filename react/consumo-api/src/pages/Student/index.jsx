...
export function Student() {
  ...
  async function handleEditStudent(event) {
    ...
    if (data.weight < 2000 || data.weight > 12000) {
      errorsExist = true
    ...
    if (data.height < 100 || data.height > 2600) {
      errorsExist = true
      toast.error('A altura precisa estar entre 1m e 2.60m!')
    }
        ...
        <Form onSubmit={handleEditStudent}>
          ...
          <InputsContainer>
            <fieldset>
              ...
              <Input
                ...
                onChange={handleChange}
                value={formatDateToInput(data.age)}
              />
            </fieldset>
          ...
          <ButtonsContainer>
            ...
            <button type="submit" disabled={isLoading}>
              {!isLoading ? 'Confirmar edição' : 'Carregando...'}
            </button>
          </ButtonsContainer>
        </Form>
      )}
